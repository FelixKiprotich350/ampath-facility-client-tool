-- TX_CURR <6 months on ART - Advanced (WHO Stage III & IV)
    ...
    FROM (
        ...
        from (select fup.visit_date,
              ...
              having (started_on_drugs is not null and started_on_drugs <> '')
                 and timestampdiff(MONTH, date(art_start_date), date('2025-10-31 00:00:00')) < 6
                 and who_stage in (1206, 1207)
                 and (
                  (
