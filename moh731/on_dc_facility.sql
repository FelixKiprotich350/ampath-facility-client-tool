-- On DC - Facility (Health facility based differentiated care - 3 to 6 months on ART)
...
FROM (
    ...
    FROM (
        ...
        where t.differentiated_care_setting = 1537
          and timestampdiff(MONTH, date(t.art_start_date), date('2025-10-31 00:00:00')) between 3 and 6
    ) c
