-- Active males for the last 12 months in Male Clinic with VL
...
FROM (
    ...
    FROM (
        ...
        from (select fup.patient_id,
                     ...
                     max(vl.visit_date)                                                               as latest_vl_date
              from kenyaemr_etl.etl_patient_hiv_followup fup
                       ...
                       left join kenyaemr_etl.etl_laboratory_extract vl
                                  ...
                                  and vl.visit_date between date_sub(date('2025-10-31 00:00:00'), interval 12 MONTH) and date('2025-10-31 00:00:00')
                       left outer JOIN
                   (select patient_id,
              ...
              having (started_on_drugs is not null and started_on_drugs <> '')
                 and p.Gender = 'M'
                 and latest_vl_date is not null
                 and (
                  (
