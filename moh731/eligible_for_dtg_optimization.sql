...
FROM (
    ...
    FROM (
        ...
        from (select f.patient_id,
                     ...
                     de.date_started as art_start_date
              from kenyaemr_etl.etl_patient_hiv_followup f
                       join kenyaemr_etl.etl_hiv_enrollment e on f.patient_id = e.patient_id
              ...
              group by f.patient_id) t
        where t.stability = 1
          and t.current_regimen not like '%DTG%'
          and timestampdiff(MONTH, date(t.art_start_date), date('2025-10-31 00:00:00')) >= 6
    ) c
